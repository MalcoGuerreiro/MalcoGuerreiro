...
I'm **Malco**, a Computer Engineering student at **CESUPA**, from Brazil.
...
My personal corner of the internet — a Wii-inspired website where I share projects, music, games and whatever I'm into lately.

`JavaScript` · `Node.js` · `Supabase` · `Vercel` · `Last.fm API`

[**open site ↗**](https://malco-guerreiro.vercel.app/) · [**source code ↗**](https://github.com/MalcoGuerreiro/malcos-corner)

## 🧰 toolbox

<p align="left">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=js,html,css,nodejs,java,python,c,git,github,vscode,vercel,supabase&perline=12" />
  </a>
</p>
